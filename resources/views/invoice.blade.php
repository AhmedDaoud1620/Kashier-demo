...
@section('content')
    <div class="container">
        ...
        <div class="invoice-container">
            ...
            <div class="invoice-status d-flex justify-content-between">
                <p><strong>Status:</strong> <span class="{{$order->payment->status == 'paid' ? 'text-success' : 'text-danger'}}">{{$order->payment->status}}</span></p>
